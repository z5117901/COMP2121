...
.def mask =r19
.def temp2 =r20
.def intermediateL = r23
.def intermediateH = r24
...
load_number:  ; converts the number into a binary number
	push temp
	mul intermediateL, ten
	mov r11, r0
	mov r12, r1

	clr r0
	clr r1
	mul intermediateH, ten
	mov r13, r0
	mov r17, r1

	cpi r17, 0
	brne overflow_occured
	mov intermediateL, r11
	add r12, r13

	mov intermediateH, r13

	subi temp, '0'
	add intermediateL, temp
	sbci intermediateH, 0

	out PORTC, intermediateL
	pop temp
	ret

do_calculation_add:	; does the calculation 
